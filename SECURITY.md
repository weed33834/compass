...
Instead, report them privately. The preferred channel is GitHub's private security advisory at <https://github.com/weed33834/compass/security/advisories/new>. Alternatively, email the maintainer directly — the contact email is listed on the maintainer's GitHub profile page. The maintainer will acknowledge receipt within 48 hours and provide a timeline for a fix.
